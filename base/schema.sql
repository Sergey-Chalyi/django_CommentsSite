--
-- File generated with SQLiteStudio v3.4.4 on ?? ??? 14 18:17:59 2024
--
...
CREATE TABLE "comments_comment" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "user_name" varchar(255) NOT NULL, "email" varchar(254) NOT NULL, "text" text NOT NULL, "time_created" datetime NOT NULL, "attachment" varchar(100) NULL, "parent_comment_id" bigint NULL REFERENCES "comments_comment" ("id") DEFERRABLE INITIALLY DEFERRED);
...
-- Index: comments_comment_parent_comment_id_71289d4a
